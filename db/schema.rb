...
ActiveRecord::Schema[7.0].define(version: 2023_05_04_094719) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.decimal "price_at_checkout", precision: 6, scale: 2, null: false
  ...
  add_foreign_key "shopping_baskets", "products"
